/*
 * Crypto.java
 * IUT de Rodez, INFO2, 2024-2025, pas de copyright
 */
...
/**
 * Permet de générer un nombre premier, un générateur, de
 * calculer l'exponentiation modulaire et de chiffrer/déchiffrer
 * un message en utilisant l'algorithme de Vigenère.
...
public class Crypto {
    ...
    /**
     * Constructeur de la classe gestion_donnees. Crypto.
     *
    ...
    /**
     * Constructeur vide de la classe gestion_donnees.Crypto pour instancier le client.
     */
    public Crypto() {
    ...
    public static int genererPremier(int n) {
        ...
        // Retourne deux si aucun nombre premier n'est trouvé (deux est le plus petit nombre premier).
        return 2;
    }

    /**
     * Vérifie si un nombre est premier.
     * @param n le nombre a vérifié.
    ...
    public static boolean estPremier(int n) {
        ...
        for (int i = 2; i <= Math.sqrt(n); i++) {
            // Si n n'est divisible que par i, n n'est pas premier
            if (n % i == 0) {
                return false;
            }
        }
    ...
    public static int exponentiationModulaire(int base, int exposant, int modulo) {
        ...
        while (exposant > 0) {
            ...
            // Divise l'exposant par deux en utilisant un décalage binaire à droite.
            exposant = exposant >> 1;
     ...
     *
     * @param p le nombre premier.
     * @param generateur le générateur a vérifié.
     ...
     *
     * @param message le message a déchiffré.
