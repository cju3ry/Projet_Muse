...
import application.ControleurImporterDistance;
import application.ControleurImporterLocal;
import application.ControleurPageDeGarde;
...
public class Filtre {
	...
	private ArrayList<Visite> visiteInitial;
	private ArrayList<Exposition> expositionInitial;
	private ArrayList<Conferencier> conferencierInitial;

	public Filtre() {
		boolean donneesChargeesLocal = ControleurImporterLocal.isDonneesVisitesChargees();
		boolean donnesChargeesDistance = ControleurImporterDistance.isDonneesVisitesChargees();
		boolean donnesChargeesSauvegarder = ControleurPageDeGarde.isDonneesSaveChargees();
	...
	public void reset() {
		...
		expositionInitial = donnees.getExpositions();
		conferencierInitial = donnees.getConferenciers();
